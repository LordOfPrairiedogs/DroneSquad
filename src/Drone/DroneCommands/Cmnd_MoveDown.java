...
/**
 * Sends the "move-down" command. to create a new command copy'n'paste this code
 * into a new command class, and change names and the AT_COMMAND_STRING's
 *
 * @author orpheus
 */
public class Cmnd_MoveDown implements ATCommand {
     ...
     */
    public Cmnd_MoveDown(InetAddress ipAddress, DatagramSocket socket) {
