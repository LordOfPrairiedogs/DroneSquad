...
/**
 * Sends the "turn-left" command. to create a new command copy'n'paste this code
 * into a new command class, and change names and the AT_COMMAND_STRING's
 *
 * @author orpheus
 */
public class Cmnd_TurnLeft implements ATCommand {
     ...
     */
    public Cmnd_TurnLeft(InetAddress ipAddress, DatagramSocket socket) {
