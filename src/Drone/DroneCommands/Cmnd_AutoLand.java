...
/**
 * Sends the "landing" command. to create a new command copy'n'paste this code
 * into a new command class, and change names and the AT_COMMAND_STRING's
 *
 * @author orpheus
 */
public class Cmnd_AutoLand implements ATCommand {
     ...
     **/
    private static final String AT_COMMAND_STRING2 = ",290717696";
    /**
     ...
     */
    public Cmnd_AutoLand(InetAddress ipAddress, DatagramSocket socket) {
