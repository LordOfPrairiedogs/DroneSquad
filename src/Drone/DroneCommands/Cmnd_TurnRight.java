...
/**
 * Sends the "turn-right" command. to create a new command copy'n'paste this code
 * into a new command class, and change names and the AT_COMMAND_STRING's
 *
 * @author orpheus
 */
public class Cmnd_TurnRight implements ATCommand {
     ...
     **/
    private static final String AT_COMMAND_STRING2 = ",1,0,0,0,";
    /**
     * speed constant
     **/
     ...
     */
    public Cmnd_TurnRight(InetAddress ipAddress, DatagramSocket socket) {
