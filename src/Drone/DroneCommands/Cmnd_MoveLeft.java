...
/**
 * Sends the "move-left" command. to create a new command copy'n'paste this code
 * into a new command class, and change names and the AT_COMMAND_STRING's
 *
 * @author orpheus
 */
public class Cmnd_MoveLeft implements ATCommand {
     ...
     */
    public Cmnd_MoveLeft(InetAddress ipAddress, DatagramSocket socket) {
