...
/**
 * Sends the "move-right" command. to create a new command copy'n'paste this code
 * into a new command class, and change names and the AT_COMMAND_STRING's
 *
 * @author orpheus
 */
public class Cmnd_MoveRight implements ATCommand {
     ...
     **/
    private static final String AT_COMMAND_STRING2 = ",1,";
    /**
     * command string part 2
     **/
    private static final String AT_COMMAND_STRING3 = ",0,0,0";
    /**
     * speed constant
     **/
     ...
     */
    public Cmnd_MoveRight(InetAddress ipAddress, DatagramSocket socket) {
